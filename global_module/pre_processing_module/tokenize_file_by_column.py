...
tokenize_by_column('/home/aykumar/aykumar_home/self/sequential_match/global_module/utility_dir/folder1/data/base_data/test/jpmc_demo_test_raw_transformed.txt', 0)