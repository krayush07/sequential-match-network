def generate_4context_seq():
    input_file = '/home/aykumar/aykumar_home/self/sequential_match/global_module/utility_dir/folder1/data/base_data/valid/jpmc_demo_valid_raw_transformed.txt_tokenized'
